...
def generate_launch_description():
    ...
    default_rviz_config_path = os.path.join(pkg_share, 'rviz/lidartest.rviz')
    ...
    start_lidarright_filter =  Node(
            ...
            parameters=[
                PathJoinSubstitution([
                    laser_filters_pkg,
                    "test",  # Assuming the configuration files are stored in a 'config' folder within the package
    ...
    start_lidarleft_filter =  Node(
            ...
            name="scan_to_scan_filter_chain_left",
             ...
             parameters=[
                PathJoinSubstitution([
                    pkg_share,
                    "config",  # Assuming the configuration files are stored in a 'config' folder within the package
                    "filter_left.yaml"
                ])
            ],
        )
