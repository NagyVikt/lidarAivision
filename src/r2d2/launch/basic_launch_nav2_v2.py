...
def generate_launch_description():
  ...
  robot_name_in_model = 'basic_mobile_robot'
  ...
  default_model_path = os.path.join(pkg_share, 'models/newmodel_v4.urdf')

  sdf_model_path = os.path.join(pkg_share, default_model_path)

  robot_localization_file_path = os.path.join(pkg_share, 'config/ekfultimate.yaml')

  robot_name_in_urdf = 'basic_mobile_bot'
  default_rviz_config_path2 = os.path.join(pkg_share, 'rviz/slamwithrealsense.rviz')
  ...
  nav_to_charging_dock_script = os.path.join(pkg_share, 'scripts/navigate_to_charging_dock.py')
...
# Pose where we want to spawn the robot
  ...
  static_map_path = os.path.join(pkg_share, 'maps', 'map_1688027577.yaml')
  ...
  depthimage_to_laserscan_node = ComposableNode(
  ...
  container = ComposableNodeContainer(
    ...
    composable_node_descriptions=[depthimage_to_laserscan_node],
    output='screen',
