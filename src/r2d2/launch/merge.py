...
def generate_launch_description():
    ...
    pointCloudTopic = LaunchConfiguration('pointCloudTopic', default="/points2")
    pointCloutFrameId = LaunchConfiguration('pointCloutFrameId', default="camera_depth_optical_frame")
    
    #parameter for the first laserscan, feel free to duplicate and rename for other laserscans
    scanTopic1 = LaunchConfiguration('scanTopic1', default="/scan_1")
    ...
    scanTopic2 = LaunchConfiguration('scanTopic2', default="/scan_2")
