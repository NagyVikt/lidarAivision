...
def generate_launch_description():
 ...
 # Declare the launch arguments  
  ...
  # Start Cartographer occupancy grid node
    ...
    #     arguments=['0', '0', '0', '0.73', '0', '0', '1', 'base_footprint', 'odom'],
    ...
    # start_my_tf2_cpp_node_cmd = Node(
    # package='my_tf2_cpp_pkg',
    # executable='my_tf2_cpp_node',
    # name='my_tf2_cpp_node',
    # output='screen'
    # )
    ...
    #ld.add_action(start_bno055_buffer_node_cmd)
    ...
    #ld.add_action(start_my_tf2_cpp_node_cmd)
